...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  loadReviewedFiles: (repoPath, key) => ipcRenderer.invoke('comments:loadReviewed', repoPath, key),
  saveReviewedFiles: (repoPath, key, reviewedFiles) => ipcRenderer.invoke('comments:saveReviewed', repoPath, key, reviewedFiles),
